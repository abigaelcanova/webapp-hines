...
export function ContentCard({
  ...
  if (layout === "vertical") {
    return (
      <div
        className={`bg-white rounded-2xl shadow-sm border hover:shadow-md transition-shadow duration-200 overflow-hidden ${className}`}
      >
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-200 overflow-hidden h-36 ${className}`}
    >
